...
{
    public partial class viewBienvenida : DevExpress.XtraEditors.XtraUserControl, IPage
    {
        public viewBienvenida()
        {
            InitializeComponent();

            this.Parent = new DevExpress.XtraWizard.WelcomeWizardPage();
            this.Parent.Text = Constantes.Titulos.Bienvenida;
