                    ...
                    'Controles': {
                        'Dispensarios': {<%for (int i = 0; i < this.Dispensarios.Count; i++){ %>
                            'Dispensario<% Response.Write(this.Dispensarios[i].posicion.ToString("D2")); %>': new Adicional.Dispensarios.Dispensario({
                                ...
                                'tipo': <% Response.Write((int)((Adicional.Entidades.Estacion)HttpContext.Current.Session[AdminSession.ESTACION]).TipoDispensario); %>,
                                'Async': {
                                    'url': 'GetMangueras',
            ...
            <div class="modal-content">
                <div class="modal-header" style="cursor: move">
                    ...
                    <h3 class="modal-title" id="myModalLabel">
                        <span id="ttlPos" class="label label-success">&nbsp;
                            <span id="ttlText" class="badge"></span>
                        </span>
    ...
    <script type="text/javascript">
        ...
        var fnOperation = function() {
            ...
            $('#dlgModal').on('show.bs.modal', function(event) {
                ...
                modal.find('.modal-title #ttlPos').html(posicion + "&nbsp;").append(temp);
