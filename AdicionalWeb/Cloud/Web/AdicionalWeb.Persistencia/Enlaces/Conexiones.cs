...
namespace AdicionalWeb.Persistencia.Enlaces
{
    internal class Conexiones
    {
        ...
        {
            internal static string _gasolinera;
            internal static string _adicionalHost;
            internal static string _adicionalCliente;
            ...
            public string Gasolinera
            {
                get
                {
                    ...
                    {
                        _gasolinera = findConnectionString("Gasolinera");
                    }
            ...
            public string AdicionalHost
            {
                get
                {
                    if (string.IsNullOrEmpty(_adicionalHost))
                    {
                        _adicionalHost = findConnectionString("AdicionalHost");
                    }
            ...
            public string AdicionalCliente
            {
                get
                {
                    ...
                    {
                        _adicionalCliente = findConnectionString("AdicionalCliente");
                    }
