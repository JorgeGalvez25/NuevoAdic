...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="alert alert-info" role="alert">
                <div class="media">
                    <span class="media-left" aria-hidden="true" style="display: inline-block"><i class="fa fa-exclamation-circle fa-2x">
                    </i></span>
    ...
    <script type="text/javascript">        $(document).ready(function() { $('#ctl00_Content_btnValidar').off('click').removeAttr('onclick'); $('form').on('submit', function() { __doPostBack('ctl00$Content$btnValidar', ''); return false; }); }); </script>
</asp:Content>
